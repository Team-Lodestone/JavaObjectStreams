...
namespace javaobject::type::parser::descriptor {
    std::unique_ptr<object::IObject> ClassDescriptorInfoParser::operator()(TypeCodeParser &parser) const {
        ...
        return std::make_unique<object::descriptor::ClassDescriptorInfoObject>(flags, std::move(objects), std::move(classAnnotation),
