...
namespace javaobject::type::object::parsers::descriptor {
    std::shared_ptr<object::IObject> NewClassDescriptorParser::operator()(ObjectTypeCodeParser &parser) const {
        ...
        parser.handleContainer().registerHandle(desc); //register handle
