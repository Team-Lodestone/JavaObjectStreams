/** @file PrimitiveDoubleObjectParser.cpp
 *
...
namespace javaobject::type::primitive::parsers {
    std::shared_ptr<types::IPrimitiveObject> PrimitiveDoubleObjectParser::operator()(PrimitiveTypeCodeParser &parser) const {
        return std::make_unique<types::PrimitiveDoubleObject>(parser.stream().readBE<double>());
    }
} // namespace javaobject::type::primitive::parsers