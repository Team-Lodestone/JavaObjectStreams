/** @file PrimitiveLongObjectParser.cpp
 *
...
namespace javaobject::type::primitive::parsers {
    std::shared_ptr<types::IPrimitiveObject> PrimitiveLongObjectParser::operator()(PrimitiveTypeCodeParser &parser) const {
        return std::make_unique<types::PrimitiveLongObject>(parser.stream().readBE<int64_t>());
    }
} // namespace javaobject::type::primitive::parsers