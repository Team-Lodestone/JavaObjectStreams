/** @file PrimitiveBooleanObjectParser.cpp
 *
...
namespace javaobject::type::primitive::parsers {
    std::shared_ptr<types::IPrimitiveObject> PrimitiveBooleanObjectParser::operator()(PrimitiveTypeCodeParser &parser) const {
        return std::make_unique<types::PrimitiveBooleanObject>(parser.stream().readByte());
    }
} // namespace javaobject::type::primitive::parsers