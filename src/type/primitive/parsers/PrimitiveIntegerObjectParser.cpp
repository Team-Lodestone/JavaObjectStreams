/** @file PrimitiveIntegerObjectParser.cpp
 *
...
namespace javaobject::type::primitive::parsers {
    std::shared_ptr<types::IPrimitiveObject> PrimitiveIntegerObjectParser::operator()(PrimitiveTypeCodeParser &parser) const {
        return std::make_unique<types::PrimitiveIntegerObject>(parser.stream().readBE<int32_t>());
    }
} // namespace javaobject::type::primitive::parsers